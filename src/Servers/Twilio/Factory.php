...
use Laravel\Reverb\Protocols\Twilio\Http\Controllers\ChannelController;
use Laravel\Reverb\Protocols\Twilio\Http\Controllers\ChannelsController;
use Laravel\Reverb\Protocols\Twilio\Http\Controllers\ChannelUsersController;
use Laravel\Reverb\Protocols\Twilio\Http\Controllers\ConnectionsController;
use Laravel\Reverb\Protocols\Twilio\Http\Controllers\EventsBatchController;
use Laravel\Reverb\Protocols\Twilio\Http\Controllers\EventsController;
use Laravel\Reverb\Protocols\Twilio\Http\Controllers\HealthCheckController;
use Laravel\Reverb\Protocols\Twilio\Http\Controllers\TwilioController;
use Laravel\Reverb\Protocols\Twilio\Http\Controllers\UsersTerminateController;
use Laravel\Reverb\Protocols\Twilio\Managers\ArrayChannelConnectionManager;
use Laravel\Reverb\Protocols\Twilio\Managers\ArrayChannelManager;
use Laravel\Reverb\Protocols\Twilio\PusherPubSubIncomingMessageHandler;
...
use Laravel\Reverb\Servers\Twilio\Http\Route;
use Laravel\Reverb\Servers\Twilio\Http\Router;
use Laravel\Reverb\Servers\Twilio\Http\Server as HttpServer;
...
class Factory
{
    ...
    protected static function pusherRoutes(): RouteCollection
    {
        ...
        $routes->add('sockets', Route::get('/app/{appKey}', new TwilioController(app(PusherServer::class), app(ApplicationProvider::class))));
